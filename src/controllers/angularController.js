...
export const getAndInsertAngularTweets = async (next_token) => {
  const query = {
    "query": "angular js OR angular programming OR angular library OR learn angular js lang:en -\"Essaydue\" -\"paywrite\" -\"essaypay\" -\"homeworkdue\" -\"assignmentdue\" -\"assignment due\" -\"essay pay\" -\"Essay due\" -\"pay write\" -\"Essays\"",
    "max_results": "100",
